...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/dadage456/YPWebView"
  ...
  s.source       = { :git => "https://github.com/dadage456/YPWebView.git", :tag => "1.2.0" }
...
s.source_files  =  "YPWebView","Classes/*.{h,m}","Classes/ScriptMessageHandler/*.{h,m}"
